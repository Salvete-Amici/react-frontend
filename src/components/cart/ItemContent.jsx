        ...
        <div className="md:w-36 sm:w-24 w-12">
          <img
            src={
              image?.startsWith("http")
                ? image
                : `${import.meta.env.VITE_BACK_END_URL}/images/${
                    image || "default.jpg"
                  }`
            }
            ...
            onError={(event) => {
              ...
              event.currentTarget.src = `${import.meta.env.VITE_BACK_END_URL}/images/default.jpg`;
            }}
          ...
          <div className="flex items-start gap-5 mt-3">
            <button
              ...
              className="flex items-center font-semibold space-x-2 px-4 py-1 text-xs border-1 border-rose-600 text-rose-600 rounded-md hover:bg-red-50 transition-colors duration-200"
            >
              <FaTrashAlt size={16} className="text-rose-300" />
              Remove
            </button>
          </div>
        </div>
